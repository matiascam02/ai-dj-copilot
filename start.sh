...
pip3 install --break-system-packages sounddevice soundfile scipy websockets python-multipart librosa 2>&1 | grep -E "(Successfully|already)" || echo "✓ Dependencies ready"
